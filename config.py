...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '5456404296:AAFTyI_sKE0_hHNuu5L3qsLxi8YfNV3paro' # Get it from https://t.me/BotFather
    APP_ID = '15532517' # Get it from my.telegram.org/apps
    API_HASH = 'aab9c10b85949d492252f37d99c7ddf2' # Get it from my.telegram.org/apps
